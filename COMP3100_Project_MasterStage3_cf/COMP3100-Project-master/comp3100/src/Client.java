...
public class Client{
        ...
        if(args.length == 1){
            ...
            arg = args[0];
            if(arg.equals("-a") && (args[1].equals("ff") || args[1].equals("bf") || args[1].equals("wf") || args[1].equals("cf") || args[1].equals("cf1") || args[1].equals("cf2") || args[1].equals("cf3") )){
                method = args[1];
            } else {
        ...
        try{
            ...
            if(method.equals("ff"))
                ...
                scheduler.cumulativeFit(parser.servers);
            else if(method.equals("cf1"))
                scheduler.cumulativeFit1(parser.servers);
            else if(method.equals("cf2"))
                scheduler.cumulativeFit2(parser.servers);
            else if(method.equals("cf3"))
                scheduler.cumulativeFit3(parser.servers);
            else
